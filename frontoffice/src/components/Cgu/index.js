  ...
  <Layout layoutClass="cgu">
    ...
    <div className="cgu__content">
      ...
      <p>
        ...
        l'encadrement juridique de l’utilisation du site SpeedyQuiz et de ses
        services. Ce contrat est conclu entre :
      </p>
      <p>
        Les gérants du site internet, ci-après désignés Malika, John, Eddy,
        Florian. Toute personne physique ou morale souhaitant accéder au site et
        à ses services, ci-après appelé « l’Utilisateur ». Les conditions
      ...
      <p>
        Le site SpeedyQuiz est édité par la société O'SpeedyGames, SARL, au
        capital de 10 €, dont le siège social est situé au [adresse du siège
        social]. La société est représentée par Malika, John, Eddy, Florian.
        Pour les personnes physiques :
      </p>
      <p>
        Le site [nom du site] est édité par Malika, John, Eddy, Florian,
        domicilié au [adresse postale].
      </p>
      ...
      <p>
        ...
        à la charge de l’Éditeur. Les services suivants ne sont pas accessible
        pour l’Utilisateur que s’il est membre du site (c’est-à-dire qu’ile st
      ...
      <p>
        ...
        présents sur le site SpeedyQuiz. Tout usage du service par l'Utilisateur
        ayant directement ou indirectement pour conséquence des dommages doit
        faire l'objet d'une indemnisation au profit du site. Le site permet aux
        membres de publier sur le site :
      </p>
      <p>
        [Commentaires] ; [Oeuvres] ; Etc. Le membre s’engage à tenir des propos
      ...
      <p>
        ...
        insurmontable d'un tiers. Le site SpeedyQuiz s'engage à mettre en œuvre
      ...
      <p>
        Les contenus du site SpeedyQuiz (logos, textes, éléments graphiques,
      ...
      <p>
        ...
        [nom de votre site] pour la communication d’informations diverses et la
        gestion du compte. SpeedyQuiz garantie le respect de la vie privée de
        l’utilisateur, conformément à la loi n°78-17 du 6 janvier 1978 relative
        à l'informatique, aux fichiers et aux libertés. Le site est déclaré
        auprès de la CNIL sous le numéro suivant :
      </p>
      <p>
        [numéro] En vertu des articles 39 et 40 de la loi en date du 6 janvier
        ...
        exerce ce droit via : Son espace personnel sur le site ; Un formulaire
        de contact ; Par mail à [adresse mail de l’administrateur] ; Par voie
        postale au [votre adresse].
      </p>
      <h3>ARTICLE 8 : Liens hypertextes</h3>
      <p>
        Les domaines vers lesquels mènent les liens hypertextes présents sur le
        site n’engagent pas la responsabilité de l’Éditeur de SpeedyQuiz, qui
        n’a pas de contrôle sur ces liens. Il est possible pour un tiers de
        créer un lien vers une page du site SpeedyQuiz sans autorisation
        expresse de l’éditeur.
      </p>
      <h3>ARTICLE 9 : Évolution des conditions générales d’utilisation</h3>
      <p>
        Le site SpeedyQuiz se réserve le droit de modifier les clauses de ces
      ...
      <p>
        ...
        de [nom de ville] sont compétents pour régler le contentieux.
      </p>
    </div>
  </Layout>
);
