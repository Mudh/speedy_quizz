...
const cgu = () => (
  <Layout layoutClass="cgu">
    <h2 className="cgu__title">Conditions générales d'utilisation du site SpeedyQuiz</h2>
    <div className="cgu__content">

      <h3>ARTICLE 1 : Objet</h3>
      <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique de l’utilisation du site SpeedyQuiz et de ses services. Ce contrat est conclu entre :</p>
      <p>Les gérants du site internet, ci-après désignés Malika, John, Eddy, Florian. Toute personne physique ou morale souhaitant accéder au site et à ses services, ci-après appelé « l’Utilisateur ». Les conditions générales d'utilisation doivent être acceptées par tout Utilisateur, et son accès au site vaut acceptation de ces conditions.</p>
      <h3>ARTICLE 2 : Mentions légales</h3>   
      <p>Pour les personnes morales :</p>
      <p>Le site SpeedyQuiz est édité par la société O'SpeedyGames, SARL, au capital de 10 €, dont le siège social est situé au [adresse du siège social]. La société est représentée par Malika, John, Eddy, Florian. Pour les personnes physiques :</p>
      <p>Le site [nom du site] est édité par Malika, John, Eddy, Florian, domicilié au [adresse postale].</p>
      <h3>ARTICLE 3 : accès aux services</h3>   
      <p>L’Utilisateur du site SpeedyQuiz a accès aux services suivants :</p>
      <ul>
        <li>[Service n°1]</li>
        <li>[Service n°2]</li>
        <li>[Service n°3]</li>
      </ul>
      <p>Tout Utilisateur ayant accès a internet peut accéder gratuitement et depuis n’importe où au site. Les frais supportés par l’Utilisateur pour y accéder (connexion internet, matériel informatique, etc.) ne sont pas à la charge de l’Éditeur. Les services suivants ne sont pas accessible pour l’Utilisateur que s’il est membre du site (c’est-à-dire qu’ile st identifié à l’aide de ses identifiants de connexion) :</p>
      <ul>
        <li>[Service n°1]</li>
        <li>[Service n°2]</li>
        <li>[Service n°3]</li>
      ...
      <p> L'Utilisateur est responsable des risques liés à l’utilisation de son identifiant de connexion et de son mot de passe. 
          ...
          L’Utilisateur assume l’entière responsabilité de l’utilisation qu’il fait des informations et contenus présents sur le site SpeedyQuiz.
          Tout usage du service par l'Utilisateur ayant directement ou indirectement pour conséquence des dommages doit faire l'objet d'une indemnisation au profit du site.
          Le site permet aux membres de publier sur le site :</p>
      <p>[Commentaires] ;
         [Oeuvres] ;
         Etc.
      ...
      Le site SpeedyQuiz s'engage à mettre en œuvre tous les moyens nécessaires pour garantir la sécurité et la confidentialité des données. Toutefois, il n’apporte pas une garantie de sécurité totale.
      ...
      <p> 
      Les contenus du site SpeedyQuiz (logos, textes, éléments graphiques, vidéos, etc.) son protégés par le droit d’auteur, en vertu du Code de la propriété intellectuelle.
      ...
      SpeedyQuiz garantie le respect de la vie privée de l’utilisateur, conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.
      Le site est déclaré auprès de la CNIL sous le numéro suivant :</p>
      <p>
      [numéro]
      ...
      <p> 
      Les domaines vers lesquels mènent les liens hypertextes présents sur le site n’engagent pas la responsabilité de l’Éditeur de SpeedyQuiz, qui n’a pas de contrôle sur ces liens.
      Il est possible pour un tiers de créer un lien vers une page du site SpeedyQuiz sans autorisation expresse de l’éditeur.
      </p>
      <h3>ARTICLE 9 : Évolution des conditions générales d’utilisation</h3>  
      <p> 
      Le site SpeedyQuiz se réserve le droit de modifier les clauses de ces conditions générales d’utilisation à tout moment et sans justification.
      </p>
